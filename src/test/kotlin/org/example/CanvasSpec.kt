        ...
        describe("PPM output") {
            ...
            describe("splitting long lines in PPM files") {
                ...
                it("lines 4-11 will be") {
                    assertEquals("255 204 153 255 204 153 255 204 153 255 204 153 255 204 153 255 204", result[3])
                    assertEquals("153 255 204 153 255 204 153 255 204 153 255 204 153 255 204 153 255", result[4])
                    assertEquals("204 153 255 204 153 255 204 153 255 204 153 255 204 153 255 204 153", result[5])
                    assertEquals("255 204 153 255 204 153 255 204 153", result[6])
                    assertEquals("255 204 153 255 204 153 255 204 153 255 204 153 255 204 153 255 204", result[7])
                    assertEquals("153 255 204 153 255 204 153 255 204 153 255 204 153 255 204 153 255", result[8])
                    assertEquals("204 153 255 204 153 255 204 153 255 204 153 255 204 153 255 204 153", result[9])
                    assertEquals("255 204 153 255 204 153 255 204 153", result[10])
                }
            }
        }
    }
